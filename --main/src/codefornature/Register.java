    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        ...
        try{
            ...
            if("".equals(fUsername.getText())){
                ...
                username=fUsername.getText().trim();
                email=fEmail.getText().trim();
                password=fPassword.getText();
                String hashedPassword = PasswordHashing.hashPassword(password);
                query="INSERT INTO user(username,email,password,hashedPassword, points)"+"VALUES('"+username+"','"+email+"','"+password+"','"+hashedPassword+"','"+points+"')";
                st.execute(query);
                fUsername.setText("");
                fEmail.setText("");
                fPassword.setText("");
